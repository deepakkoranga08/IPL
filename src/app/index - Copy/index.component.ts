...
export class IndexComponent implements OnInit{
 ...
 Team1=["T1Person 1B","T1Person 2B","T1Person 3A","T1Person 4B","T1Person 5A","T1Person 6B","T1Person 7B","T1Person 8B","T1Person 9B","T1Person 10B","T1Person 11B","T1Person 12B","T1Person 13B","T1Person 14B","T1Person 15B"]
 ...
 {
   let value=event.target.value
   if(value=="Team1"){this.PlayersLabel=this.Team1}
   else if(value=="Team2"){this.PlayersLabel=this.Team2}
